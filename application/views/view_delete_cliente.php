...
$input_con_id = array(
              'idCliente'        => $arraycliente[0]->idCliente,
            );
...
?><div id="container">
	...
	echo form_open();
	  ...
	  echo '<tr>';
	  echo "<td height='10' class='tabla_ventanas_login' height='10' colspan='3'><legend align='center'>Eliminar Información de ".$arraycliente[0]->nombres.' '.$arraycliente[0]->apellidos."</legend></td>";
	  echo '</tr>';
